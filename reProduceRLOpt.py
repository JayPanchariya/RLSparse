...
generation_num = 2500  #number of theta updates for REINFORCE-IP, also serves as the number
...
plt.savefig("escape1D-REINFROCE-traj.png")
plt.show()
...
plt.ylabel('$\mathcal{L}(x)$',size=25)
plt.legend(loc='lower right',fontsize=20)   
plt.savefig("escape1D-grad-traj.png")
plt.show()
...
plt.savefig("escape-fitness-traj-1D.png")
plt.show()